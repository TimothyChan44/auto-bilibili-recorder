...
#     apt-get update && apt-get install -y wget ffmpeg fonts-noto-color-emoji fonts-noto-cjk-extra cmake python3 python3-pip && \
#     update-ca-certificates -f && \
#     apt-get update && apt-get install -y libc6 libgcc1 libgssapi-krb5-2 libicu66 libssl1.1 libstdc++6 zlib1g && \
#     # To Solve Problem: fatal: unable to access GnuTLS recv error (-110): The TLS connection was non-properly terminated.
#     apt-get update && apt-get install -y gnutls-bin && \
#     git config --global http.sslVerify false && \
#     git config --global http.postBuffer 1048576000 && \
#     \
#     wget https://github.com/PowerShell/PowerShell/releases/download/v7.1.5/powershell-7.1.5-linux-arm64.tar.gz -O powershell.tar.gz && \
#     mkdir -p /opt/pwsh && \
#     tar -xvzf powershell.tar.gz -C /opt/pwsh && \
#     \
...
#     \
#     git clone https://github.com/valkjsaaa/BililiveRecorder.git && cd BililiveRecorder && git checkout 94ca0b9e01810c46dabdd4a7feeea7b1787dbf77
...
# docker builder prune -f -a; docker-compose up --build -d